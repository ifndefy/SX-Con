...
class VendorsTab(BaseTab):
    ...
    def add_vendor_section(self):
        ...
        self.vendors_section.append(vendors_section)
    ...
    def gather_vendor_data(self, dialog):
        ...
        vendor_doc = {
            ...
            "zip_code": dialog.findChild(QLineEdit, "zip_code_input").text(),
        }
        return vendor_doc
