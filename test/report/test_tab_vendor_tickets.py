...
@pytest.fixture
def test_consignment(vendor_tickets_tab):
    ticket_number = 99999
    consignment = {
...
@pytest.fixture
def vendor_tickets_tab(app):
    api = APIHandler()
    yield VendorTicketsTab(api, db_connection)

def test_vendor_id_input(vendor_tickets_tab):
    """
    :Purpose: verifies that the vendor ID field only takes integers and results in a successful query
    :Author(s): Joe Lee
    """
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for vendor ID: 1'

def test_phone_number_input(vendor_tickets_tab):
    """
    :Purpose: verifies that the phone number field only takes integers and results in a successful query
    :Author(s): Joe Lee
    """
    tab = vendor_tickets_tab
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for phone number: 111-111-1111'

def test_first_name_inputs(vendor_tickets_tab):
    """
    :Purpose: verifies that the first name field only takes integers and results in a successful query
    :Author(s): Joe Lee
    """
    tab = vendor_tickets_tab
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for first name: first'

def test_middle_name_inputs(vendor_tickets_tab):
    """
    :Purpose: verifies that the middle name field only takes integers and results in a successful query
    :Author(s): Joe Lee
    """
    tab = vendor_tickets_tab
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for middle name: first'

def test_last_name_input(vendor_tickets_tab):
    """
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for last name: first'

def test_address_input(vendor_tickets_tab):
    """
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for address: 111 first'

def test_city_input(vendor_tickets_tab):
    """
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for city: first'

def test_state_input(vendor_tickets_tab):
    """
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for state: ft'

def test_zip_input(vendor_tickets_tab):
    """
    :Purpose: verifies that the zip field only takes integers and results in a successful query
    :Author(s): Joe Lee
    """
    tab = vendor_tickets_tab
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for zip: 11111'

def test_btns_exist(vendor_tickets_tab):
    """
...
def test_ticket_section(vendor_tickets_tab):
    """
    ...
    assert tab.tickets_section[0]['ticket_num'] is not None, 'Expected ticket number field to exist in ticket section'
    assert tab.tickets_section[0]['ticket_num'].isReadOnly(), 'Expected ticket number field to be read only'
    ...
    assert tab.tickets_section[0]['view_btn'] is not None, 'Expected View button to exist in product section'
    assert tab.tickets_section[0]['excel_btn'] is not None, 'Expected Excel button to exist in product section'
    assert tab.tickets_section[0]['pdf_btn'] is not None, 'Expected PDF button to exist in product section'
    assert tab.tickets_section[0]['print_btn'] is not None, 'Expected Print button to exist in product section'
...
def test_view_btn(vendor_tickets_tab):
    """
    ...
    assert not tab.tickets_section[0]['details_container'].isHidden()
    assert tab.tickets_section[0]['view_btn'].text() == 'Hide'
    tab.tickets_section[0]['view_btn'].click()
    assert tab.tickets_section[0]['details_container'].isHidden()
    assert tab.tickets_section[0]['view_btn'].text() == 'View'

def test_open_close_btns(vendor_tickets_tab):
    """
...
def test_pdf_btn(vendor_tickets_tab):
    """
...
def test_print_btn(vendor_tickets_tab):
    """
...
def test_excel_btn(vendor_tickets_tab):
    """
    ...
    with patch('utils.core.generate_excel.QFileDialog.getSaveFileName',
        ...
        tab.tickets_section[0]['excel_btn'].click()
    assert os.path.exists(output_path), 'Expected Excel file to be generated'
    os.remove(output_path)

def test_view_btn_details(vendor_tickets_tab):
    """
    ...
    ticket_number = tab.tickets_section[0]['ticket_num'].text().strip()
    ...
    view_ticket = tab.tickets_section[0]['view_ticket']
...
def test_view_btn_accumulated_payout(vendor_tickets_tab):
    """
...
def test_view_btn_revenue_by_type(vendor_tickets_tab):
    """
...
def test_view_btn_revenue_payout(vendor_tickets_tab):
    """
...
def test_view_ticket_btn_states(vendor_tickets_tab):
    """
...
def test_view_btn_revenue_payout_btns(vendor_tickets_tab, test_consignment):
    """
    ...
    target_section = None
    for section in tab.tickets_section:
...
def test_view_btn_revenue_payout_history_btn(vendor_tickets_tab):
    """
    ...
    tab.show()
    tab.tickets_section[0]['view_btn'].click()
    payout = tab.tickets_section[0]['view_ticket'].payout_widget
...
def test_view_payout_history_cards_exist(vendor_tickets_tab):
    """
