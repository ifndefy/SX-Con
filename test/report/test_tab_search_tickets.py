...
@pytest.fixture
def test_consignment(search_tickets_tab):
    ticket_number = 99999
    consignment = {
...
def search_tickets_tab(app):
    api = APIHandler()
    yield SearchTicketsTab(api, db_connection)

def test_ticket_number(search_tickets_tab):
    """
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) == 1, 'Expected only one ticket for ticket number: 1'

def test_datetime_input(search_tickets_tab):
    """
    ...
    assert len(tab.tickets_section) == 0, "Expected no tickets for datetime 'asdf./'"
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket(s) for datetime 04/18'

def test_status_input(search_tickets_tab):
    """
    ...
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for status: OPEN'
    tab.status_input.setCurrentIndex(1)
    assert tab.status_input.currentText() == 'CLOSED', "Expected index 1 to be 'CLOSED'"
    QTest.qWait(400)
    assert len(tab.tickets_section) > 0, 'Expected ticket sections for status: CLOSED'
...
def test_ticket_section(search_tickets_tab):
    """
...
def test_view_btn(search_tickets_tab):
    """
...
def test_open_close_btns(search_tickets_tab):
    """
...
def test_pdf_btn(search_tickets_tab):
    """
...
def test_print_btn(search_tickets_tab):
    """
...
def test_view_btn_details(search_tickets_tab):
    """
...
def test_view_btn_accumulated_payout(search_tickets_tab):
    """
...
def test_view_btn_revenue_by_type(search_tickets_tab):
    """
...
def test_view_btn_revenue_payout(search_tickets_tab):
    """
...
def test_view_ticket_btn_states(search_tickets_tab):
    """
...
def test_view_btn_revenue_payout_btns(search_tickets_tab, test_consignment):
    """
...
def test_view_btn_revenue_payout_history_btn(search_tickets_tab):
    """
...
def test_view_payout_history_cards_exist(search_tickets_tab):
    """
...
def test_view_payout_history_card_toggle(search_tickets_tab):
    """
...
def test_view_payout_history_card_content(search_tickets_tab):
    """
...
def test_view_payout_history_pdf_btn(search_tickets_tab):
    """
...
def test_view_payout_history_print_btn(search_tickets_tab):
    """
...
def test_view_payout_history_excel_btn(search_tickets_tab):
    """
