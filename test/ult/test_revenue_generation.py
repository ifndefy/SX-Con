...
def test_revenue_generation():
    #Test Rates values
    assert target.calculate_revenues(price = 1.00, quantity = 10, percentile = 25, rate = 100) == {"gross": 2.50, "vendor": 0.00, "super_x": 2.50}
    assert target.calculate_revenues(price = 1.00, quantity = 10, percentile = 25, rate = 50) == {"gross": 2.50, "vendor": 1.25, "super_x": 1.25}
    assert target.calculate_revenues(price = 1.00, quantity = 10, percentile = 100, rate = 100) == {"gross": 10.00, "vendor": 0.00, "super_x": 10.00}
    
def test_zero_rate():
    assert target.calculate_revenues(price = 1.00, quantity = 10, percentile = 100, rate = 0) == {"gross": 10.00, "vendor": 10.00, "super_x": 0.00}
...
def test_zero_percentile():
    assert target.calculate_revenues(price = 1.00, quantity = 10, percentile = 0, rate = 100), {"gross": 0.00, "vendor": 0.00, "super_x": 0.00}
